$(document).ready(function () {
    ...
    function setQuestionInformation($position){
        ...
        for($i=0; $i<options.length; $i++){
            ...
            $options_html+="<input type=\"radio\" name=\"answer\" id=\"option_"+$i+"\" value=\""+$i+"\"> <label for=\"option_"+$i+"\">"+option["title"]+"</label><br>";
    ...
    function setQuestionInterval(){
        var mcq_quations_interval_time = 60;
        ...
        mcq_quations_interval = setInterval(function(){
            ...
            if(mcq_quations_interval_time<=10){
                ...
                $('.mcq_question_timer').css('color', 'black');
            }
